...
export function ActivityFeed({ items, loading }: ActivityFeedProps) {
  ...
  return (
    <section className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg">
        ...
        <>
          <ul className="divide-y divide-slate-800">
            {visible.map((it, i) => {
              ...
              const stripe = i % 2 === 0 ? 'bg-transparent' : 'bg-card/80 backdrop-blur-md shadow-lg/40'
              const row = (
