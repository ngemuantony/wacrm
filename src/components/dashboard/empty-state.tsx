...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'flex h-full min-h-40 flex-col items-center justify-center gap-2 rounded-lg border border-dashed border-border bg-card/80 backdrop-blur-md shadow-lg/40 px-4 py-6 text-center',
        className,
      )}
    >
