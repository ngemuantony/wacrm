...
function FlowNodeCard({ data, selected }: NodeProps) {
  ...
  return (
    <div
      className={cn(
        "relative min-w-[220px] max-w-[260px] rounded-lg border bg-card/80 backdrop-blur-md shadow-lg/95 px-3 py-2 text-left shadow-lg backdrop-blur transition-colors",
        selected
    ...
    <>
      <div className="h-[70vh] w-full overflow-hidden rounded-lg border border-border bg-background">
        ...
        >
          ...
          <Controls
            className="!border-border !bg-card/80 backdrop-blur-md shadow-lg [&_button]:!border-border [&_button]:!bg-card/80 backdrop-blur-md shadow-lg [&_button:hover]:!bg-muted"
          ...
          <MiniMap
            ...
            className="!border !border-border !bg-card/80 backdrop-blur-md shadow-lg"
          />
...
function CanvasAddNodeButton() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        className="inline-flex items-center gap-1.5 rounded-md border border-border bg-card/80 backdrop-blur-md shadow-lg px-3 py-1.5 text-xs font-medium text-foreground shadow-lg transition-colors hover:bg-muted"
        aria-label="Add node"
      >
