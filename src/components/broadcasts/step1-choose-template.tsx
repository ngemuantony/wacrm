...
export function Step1ChooseTemplate({ selectedTemplate, onSelect, onNext, onBack }: Step1Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {templates.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg/50">
              ...
              <button
                ...
                className={`flex flex-col gap-3 rounded-xl border p-4 text-left transition-all ${
                  isSelected
                    ...
                    : 'border-border bg-card/80 backdrop-blur-md shadow-lg/50 hover:border-border hover:bg-card/80 backdrop-blur-md shadow-lg'
                }`}
              >
