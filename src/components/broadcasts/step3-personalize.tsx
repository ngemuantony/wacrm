  ...
  return (
    <div className="space-y-6">
      ...
      {placeholders.length === 0 ? (
        <div className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg/50 p-6 text-center">
        ...
        <div className="space-y-4">
          {placeholders.map((placeholder) => {
            ...
            return (
              <div
                key={placeholder}
                className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg/50 p-4"
              >
      ...
      <div className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg/50 p-4">
        <div className="mb-3 flex items-center gap-2">
