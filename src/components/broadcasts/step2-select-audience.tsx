...
export function Step2SelectAudience({
  ...
  return (
    <div className="space-y-6">
            ...
            <button
              ...
              className={`flex items-start gap-3 rounded-xl border p-4 text-left transition-all ${
                isSelected
                  ...
                  : 'border-border bg-card/80 backdrop-blur-md shadow-lg/50 hover:border-border'
              }`}
            >
              <div
      ...
      {audience.type === 'custom_field' && (
        <div className="space-y-3 rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg/50 p-4">
