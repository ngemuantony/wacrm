...
export function Step4ScheduleSend({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Summary Card */}
      <div className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg/50 p-4 space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-t border-border pt-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <DialogContent className="border-border bg-card/80 backdrop-blur-md shadow-lg sm:max-w-md">
            <DialogHeader>
