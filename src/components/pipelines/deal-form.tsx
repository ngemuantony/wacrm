...
export function DealForm({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="bg-card/80 backdrop-blur-md shadow-lg border-border text-foreground sm:max-w-lg w-full p-0"
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {deal && (
              <div className="space-y-2 rounded-lg border border-border bg-card/80 backdrop-blur-md shadow-lg/50 p-3">
          ...
          <div className="border-t border-border/50 bg-card/80 backdrop-blur-md shadow-lg/80 p-4">
            <div className="flex gap-2">
              <Button
                variant="outline"
