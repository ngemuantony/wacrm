...
export function PipelineSettings({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-card/80 backdrop-blur-md shadow-lg border-border max-h-[85vh] overflow-y-auto">
        <DialogHeader>
        ...
        {showDeleteConfirm ? (
          ...
          <>
            ...
            <DialogFooter className="border-border bg-card/80 backdrop-blur-md shadow-lg/50">
              <Button
                variant="destructive"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-6 z-20 flex flex-wrap gap-1 rounded-lg border border-border bg-card/80 backdrop-blur-md shadow-lg p-2 shadow-lg w-36">
            {colors.map((c) => (
              <button
                key={c}
                type="button"
