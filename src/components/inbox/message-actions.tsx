  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3 z-10 flex h-7 items-center gap-0.5 rounded-full border border-border bg-card/80 backdrop-blur-md shadow-lg/95 px-1 shadow-md backdrop-blur-sm transition-opacity",
