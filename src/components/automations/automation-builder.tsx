  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-background">
      {/* Top bar. At sub-sm widths the "Active" label is hidden and the
          ...
          gets maximum width. */}
      <header className="flex flex-shrink-0 items-center gap-2 border-b border-border bg-card/80 backdrop-blur-md shadow-lg/80 px-3 py-3 sm:gap-3 sm:px-4">
        <button
          type="button"
...
function TriggerCard({
  ...
  return (
    ...
    <div className="z-10 w-full max-w-[320px] sm:w-80">
      <div className="rounded-lg border border-border border-l-4 border-l-blue-500 bg-card/80 backdrop-blur-md shadow-lg shadow-lg">
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
  ...
  return (
    <>
      <div className={cn("z-10 flex flex-col", width)}>
        <div
          className={cn(
            "rounded-lg border border-border border-l-4 bg-card/80 backdrop-blur-md shadow-lg shadow-lg",
            meta.border,
          )}
        >
          <button
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent
          align="start"
          className="max-h-80 min-w-56 overflow-y-auto border-border bg-card/80 backdrop-blur-md shadow-lg"
        >
          {ADDABLE_STEPS.map((t) => {
