  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_380px] mt-4">
      ...
      <div className="space-y-6">
        ...
        {/* Connection Status */}
        <Alert className="bg-card/80 backdrop-blur-md shadow-lg border-border">
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registered — Meta will deliver events to Tuinnov8WaCRM'
            ...
            {registrationProbe && (
              <div className="mt-3 rounded border border-border bg-card/80 backdrop-blur-md shadow-lg/60 px-3 py-2 space-y-1.5 text-[11px]">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                won&apos;t actually route inbound messages to Tuinnov8WaCRM —
