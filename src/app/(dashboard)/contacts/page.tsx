    ...
    <div className="space-y-6">
      ...
      <div className="relative max-w-sm">
        ...
        <Input
          ...
          className="pl-8 bg-card/80 backdrop-blur-md shadow-lg border-border text-foreground placeholder:text-muted-foreground"
        />
      </div>
          ...
          <TableBody>
            {loading ? (
              ...
              contacts.map((contact) => (
                <TableRow
                  key={contact.id}
                  className="border-border hover:bg-card/80 backdrop-blur-md shadow-lg/50 cursor-pointer"
                ...
                >
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="bg-card/80 backdrop-blur-md shadow-lg border-border"
                      >
                        <DropdownMenuItem
                          onClick={(e) => {
                            e.stopPropagation();
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-card/80 backdrop-blur-md shadow-lg border-border text-foreground sm:max-w-sm">
          <DialogHeader>
