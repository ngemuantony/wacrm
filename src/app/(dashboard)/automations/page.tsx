  ...
  return (
    <div className="space-y-6">
            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg p-4 text-left transition-colors hover:border-primary/50 hover:bg-card/80 backdrop-blur-md shadow-lg/80"
                >
      ...
      {automations.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-border bg-card/80 backdrop-blur-md shadow-lg/40">
...
function AutomationCard({
  ...
  return (
    <li className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg transition-colors hover:border-border">
