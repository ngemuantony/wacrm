...
function StatCard({ label, value, total, icon, color }: StatCardProps) {
  ...
  return (
    <div className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg p-4">
...
export default function BroadcastDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Recipients Table */}
      <div className="rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="border-border bg-card/80 backdrop-blur-md shadow-lg">
                <DropdownMenuItem
