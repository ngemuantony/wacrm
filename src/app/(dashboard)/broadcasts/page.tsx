...
export default function BroadcastsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {broadcasts.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg">
        ...
        <div className="overflow-x-auto rounded-xl border border-border bg-card/80 backdrop-blur-md shadow-lg">
          <Table>
            <TableHeader>
